...
//			return;
	...
	public void getPaths(Tree tree, TreePath parent, boolean expanded,
			List<Object> list) {
	...
	public void initUi() {
		...
		btTooglePersons = new ToggleIconButton("icon.small.person", "tree.show.characters", getTogglePersonsAction());
		btTooglePersons.setSelected(true);
		toggleButtonList.add(btTooglePersons);

		btToogleLocations = new ToggleIconButton("icon.small.location", "tree.show.locations", getToggleLocationsAction());
		btToogleLocations.setSelected(true);
		toggleButtonList.add(btToogleLocations);

		btToogleScenes = new ToggleIconButton("icon.small.chapter", "tree.show.chapters", getToggleScenesAction());
		btToogleScenes.setSelected(true);
		toggleButtonList.add(btToogleScenes);

		btToogleTags = new ToggleIconButton("icon.small.tag", "tree.show.tags", getToggleTagsAction());
		btToogleTags.setSelected(true);
		toggleButtonList.add(btToogleTags);

		btToogleItems = new ToggleIconButton("icon.small.item", "tree.show.items", getToggleItemsAction());
		btToogleItems.setSelected(true);
		toggleButtonList.add(btToogleItems);

		btToogleIdeas = new ToggleIconButton("icon.small.bulb", "tree.show.ideas", getToggleIdeaAction());
		btToogleIdeas.setSelected(true);
		toggleButtonList.add(btToogleIdeas);

		btToogleStrands = new ToggleIconButton("icon.small.strand", "tree.show.strands", getToggleStrandsAction());
		toggleButtonList.add(btToogleStrands);

		btToogleParts = new ToggleIconButton("icon.small.part", "tree.show.parts", getTogglePartsAction());
	...
	private void initToolbar() {
		...
		IconButton btShowAll = new IconButton("icon.small.all", "tree.show.all", getShowAllAction());
		btShowAll.setControlButton();
		toolbar.add(btShowAll, "top,gap push");
		IconButton btShowNone = new IconButton("icon.small.none", "tree.show.none", getShowNoneAction());
		btShowNone.setControlButton();
		toolbar.add(btShowNone, "top");
		IconButton btExpand = new IconButton("icon.small.expand", "tree.expand.all", getExpandAction());
		btExpand.setControlButton();
		toolbar.add(btExpand, "top");
		IconButton btCollapse = new IconButton("icon.small.collapse", "tree.collapse.all", getCollapseAction());
	...
	void refreshTree() {
		...
		if (btToogleScenes.isSelected()) {
			scenesNode = new EntityNode("scenes", new Scene());
		...
		if (btToogleParts.isSelected()) {
			partsNode = new EntityNode("parts", new Part());
